...
<head>
  <meta charset="UTF-8" />
  <title>Croose | Pay for Your Instance</title>
...
<body>
  ...
  <div>
    ...
    <div class="container">
      ...
      <div class="info">
        <strong>Space:</strong> {{ $space->name}} <br />
        <strong>Amount: $199</strong>
      </div>

      <a href="javascript:void(0)" class="btn btn-paystack" onclick="redirectWithLoader('{{ route('payment.paystack.instance', ['uuid' => $uuid]) }}')">
